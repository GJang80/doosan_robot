  ...
  while (bLoop) {
    ...
    switch (ch) {
      ...
      case '4': {
        ...
        Drfl.task_compliance_ctrl(TargetStiffness, COORDINATE_SYSTEM_BASE,
                                  0.5f);
        Drfl.set_stiffnessx(TargetStiffness2, COORDINATE_SYSTEM_TOOL, 0.5f);
        Drfl.set_desired_force(force, fdir, COORDINATE_SYSTEM_BASE, 0.1f,
                               FORCE_MODE_ABSOLUTE);
      ...
      case '7': {
        while (1) {
          ...
          LPROBOT_POSE cal_trans_res =
              Drfl.trans(cal_trans_point, cal_trans_offset);
          for (int i = 0; i < 6; i++) {
          ...
          LPROBOT_POSE cal_fkin_res =
              Drfl.fkin(cal_fkin_q2, COORDINATE_SYSTEM_WORLD);
          ...
          // set_ref_coord_org); //2.5 핫픽스 이전 버전에서 작동 안할수 있음
          ...
          /*
                          ...
                          string play_drl_speed_res_strDrlProgram = "loop =
          ...
          bool enable_alter_motion_res = Drfl.enable_alter_motion(
              5, PATH_MODE_DPOS, COORDINATE_SYSTEM_BASE,
              enable_alter_motion_limit_dPOS,
              enable_alter_motion_limit_dPOS_per);
          ...
          bool set_singularity_handling_res1 =
          ...
          Drfl.movel(set_singularity_handling_p1, set_singularity_handling_v1,
                     set_singularity_handling_a1);
          bool set_singularity_handling_res2 =
              Drfl.set_singularity_handling(SINGULARITY_AVOIDANCE_STOP);
          cout << set_singularity_handling_res2 << endl;
          Drfl.MoveL(set_singularity_handling_p2, set_singularity_handling_v1,
                     set_singularity_handling_a1);
          bool set_singularity_handling_res3 =
              Drfl.set_singularity_handling(SINGULARITY_AVOIDANCE_VEL);
          cout << set_singularity_handling_res3 << endl;
          Drfl.MoveL(set_singularity_handling_p3, set_singularity_handling_v1,
                     set_singularity_handling_a1);
          Drfl.mwait();
          ...
          bool config_program_watch_variable_res =
              Drfl.config_program_watch_variable(VARIABLE_TYPE_INSTALL,
                                                 DATA_TYPE_FLOAT, "Pi", "3.14");
          cout << config_program_watch_variable_res << endl;

          cout << "GetCtrlBoxdigitalOutput" << endl;
          bool get_digital_output =
              Drfl.get_digital_output(GPIO_CTRLBOX_DIGITAL_INDEX_1);
          Drfl.set_digital_output(GPIO_CTRLBOX_DIGITAL_INDEX_1, FALSE);
          Drfl.set_digital_output(GPIO_CTRLBOX_DIGITAL_INDEX_2, FALSE);
          cout << "get_Ctrl_box_digital_output : " << get_digital_output
               << endl;
          bool get_digital_input_1 =
              Drfl.get_digital_input(GPIO_CTRLBOX_DIGITAL_INDEX_10);
          cout << get_digital_input_1 << endl;

          cout << "SaveSubProgram" << endl;
          bool save_sub_program =
              Drfl.save_sub_program(1, "sub", "movej([0,0,90,0,90,0], 60, 30)");
          ...
          bool parallel_axis1_res =
              Drfl.parallel_axis(parallel_axis1_x1, parallel_axis1_x2,
                                 parallel_axis1_x3, TASK_AXIS_X);
          cout << parallel_axis1_res << endl;

          Drfl.MoveJ(ready_pos, 60, 30);
          cout << "ParallelAxis2" << endl;
          float parallel_axis_2_v[3] = {1000, 700, 300};
          bool parallel_axis_2_res = Drfl.parallel_axis(
              parallel_axis_2_v, TASK_AXIS_X, COORDINATE_SYSTEM_BASE);
          ...
          /* Drfl.MoveJ(ready_pos, 60, 30);
           ...
           bool align_axis_1_res = Drfl.AlignAxis1(align_axis_1_x1,
           align_axis_1_x2, align_axis_1_x3, align_axis_1_pos, TASK_AXIS_X,
           COORDINATE_SYSTEM_BASE); cout << align_axis_1_res << endl;*/
          /*
                          Drfl.MoveJ(ready_pos, 60, 30);
                          cout << "AlignAxis2" << endl;
                          float align_axis_2_v1[3] = {400, 400, 500};
                          float align_axis_2_v2[3] = {350, 37, 430};
                          bool align_axis_2_res =
             Drfl.AlignAxis2(align_axis_2_v1, align_axis_2_v2, TASK_AXIS_X,
             COORDINATE_SYSTEM_BASE); cout << align_axis_2_res << endl;*/
          ...
          Drfl.amovel(wait_for_bolt_tight_x1, wait_for_bolt_tight_velx,
                      wait_for_bolt_tight_accx);
          bool wait_for_bolt_tight_res =
              Drfl.is_done_bolt_tightening(FORCE_AXIS_Z, 10, 5);
          ...
          bool enter_task_compliance_res =
              Drfl.task_compliance_ctrl(stx, COORDINATE_SYSTEM_TOOL, 1);
          ...
          ROBOT_POSE* calc_coord_pose_user1 = Drfl.calc_coord(
              4, 0, COORDINATE_SYSTEM_BASE, calc_coord_pos1, calc_coord_pos2,
              calc_coord_pos3, calc_coord_pos4);
          ...
          int set_coord_1_id = Drfl.set_user_cart_coord(0, set_coord_1_pos1,
          ...
          /*
                          ...
                          int set_coord_2_user =
             Drfl.ConfigUserCoordinateSystemEx(set_coord_2_vec,
             set_coord_2_org);
          */
          ...
          float set_coord_3_x[3][6] = {{0, 500, 700, 0, 0, 0},
                                       {500, 0, 700, 0, 0, 0},
                                       {300, 100, 500, 0, 0, 0}};
          // int set_coord_3_id = Drfl.ConfigUserCoordinateSystem(set_coord_3_x,
          // set_coord_3_org, COORDINATE_SYSTEM_BASE);
          /*
          cout << "UpdateUserCoordinate" << endl;

          float update_coord_pos2[6] = {100, 150, 200, 45, 180, 0};
          int update_coord_result = Drfl.overwrite_user_cart_coord(1, 102,
          update_coord_pos2);
          ...
          int get_user_coordinate_id =
              Drfl.set_user_cart_coord(0, get_user_coordinate_pos);
          USER_COORDINATE* get_user_coordinate_temp =
              Drfl.get_user_cart_coord(get_user_coordinate_id);
          for (int i = 0; i < 6; i++) {
          ...
          bool set_desired_force_res = Drfl.set_desired_force(
              set_desired_force_fd, set_desired_force_fctrl_dir);
          ...
          bool wait_for_position_CON1 = Drfl.check_position_condition_abs(
              FORCE_AXIS_X, -5, 0, COORDINATE_SYSTEM_WORLD);
          bool wait_for_position_CON2 =
              Drfl.check_position_condition_abs(FORCE_AXIS_Y, -10000, 700);
          ...
          bool wait_for_position_rel_CON3 = Drfl.check_position_condition_rel(
              FORCE_AXIS_Z, -10, -5, wait_for_position_rel_posx1,
              COORDINATE_SYSTEM_TOOL);
          cout << wait_for_position_rel_CON3 << endl;

          cout << "WaitForForceCondition" << endl;
          bool wait_for_force_fcon1 = Drfl.check_force_condition(
              FORCE_AXIS_Z, 5, 10, COORDINATE_SYSTEM_WORLD);
          ...
          bool wait_for_orientation_con1 = Drfl.check_orientation_condition(
              FORCE_AXIS_C, wait_for_orientation_posx1,
              wait_for_orientation_posx2);
          ...
          bool wait_for_orientation_rel_con1 = Drfl.check_orientation_condition(
              FORCE_AXIS_C, 0, 5, wait_for_orientation_rel_posx1);

          cout << "TransformCoordinateSystem" << endl;
          float trans_coord_base_pos[6] = {400, 500, 800, 0, 180, 15};
          ROBOT_POSE* trans_coord_tool_pos;
          trans_coord_tool_pos =
              Drfl.coord_transform(trans_coord_base_pos, COORDINATE_SYSTEM_BASE,
                                   COORDINATE_SYSTEM_TOOL);
          for (int i = 0; i < 6; i++) {
          ...
          memcpy(cal_current_posx_pos, cal_current_posx_result->_fTargetPos,
                 sizeof(float) * NUM_TASK);
          for (int i = 0; i < 6; i++) {
          ...
          int get_solution_space_sol =
              Drfl.get_solution_space(get_solution_space_p1);
          ...
          float cal_orientation_err_diff = Drfl.get_orientation_error(
              cal_orientation_err_x1, cal_orientation_err_x2, TASK_AXIS_X);
